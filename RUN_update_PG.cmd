...
del liquibase_pg.log
echo. > liquibase_pg.log

call D:\Users\Loginov-NA\Liquibase\liquibase --defaultsFile=liquibase_pg.properties --log-level=info --log-file=liquibase_pg.log update
